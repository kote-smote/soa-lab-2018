...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    private Authentication getAuthentication(String authorizationHeader) {
        ...
        if (tokenClaims != null) {
            ...
            if (username != null) {
                // TODO Jackson loses parameter type and automatically converts to LinkedHashMap
                // TODO instead of GrantedAuthority. Find solution
//                Collection<GrantedAuthority> roles = (Collection<GrantedAuthority>) tokenClaims.get("roles");
